...
function setProcessor(chip) {
  processor = chip;
  console.log("CHIP ", processor);
}
async function ReadDataFromBoardJSON(Boardname) {
...
electron.contextBridge.exposeInMainWorld("AVR_Api", {
  ...
  On_ProcessorChanges: (processor2) => {
...
electron.contextBridge.exposeInMainWorld("electronAPI", {
  ...
  DELETE_file: async (path2) => {
    promises.unlink(path2);
  },
